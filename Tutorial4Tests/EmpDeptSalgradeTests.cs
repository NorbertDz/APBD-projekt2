...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.SelectMany(emp => grades, (emp, grade) => new {EName = emp.EName, Grade = grade.Grade, IsInRange = emp.Sal >= grade.Losal && emp.Sal <= grade.Hisal }).Where(r => r.IsInRange).Select(r => new { r.EName, r.Grade }).ToList();
